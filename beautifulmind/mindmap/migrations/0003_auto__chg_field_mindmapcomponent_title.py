...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mindmap_mindmapcomponent', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'MindMapComponent.title'
        db.alter_column('mindmap_mindmapcomponent', 'title', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
